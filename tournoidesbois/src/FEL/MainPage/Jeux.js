...
function ClashOfClan(){
    return(
    <div id="coc" className="display center border">
...
function Overwatch(){
    return(
        <div id="ow" className="display center border">
...
function RocketLeague(){
    return(
        <div id="rl" className="display center border">
...
function MineCraft(){ 
    ...
    return(
        <div id="mc" className="display center">
...
function ClashRoyale(){
    return(
        <div id="cr" className="display center border">
