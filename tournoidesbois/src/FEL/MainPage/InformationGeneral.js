...
export default function GeneralInformation(){
    return(
        <div>
            <InformationGeneral />
            <div className="display border center">
                <Equipe />
                <Regle />
            </div>
        </div>
...
function InformationGeneral(){
    return(
        <div id="display listJeux"> {/** préfère renvoyer le user ici à cause que le header cache le h3 de la liste de jeux*/}
            <div className="display center border">
                <h3>But: </h3>
...
function ListJeux(){
    return(
        <div id="listJeux" className="display center border">
                <h3>Voici les jeux présents dans le tournoi:</h3>
                    <ul className="width100 nodotlist">
                        <li className="display listjeux ">
